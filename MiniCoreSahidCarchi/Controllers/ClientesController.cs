...
namespace MiniCoreSahidCarchi.Controllers
{
    public class ClientesController : Controller
    {
        ...
        public ClientesController(MiniCoreSahidCarchiContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name")] Cliente cliente)
        {
            ...
            {
                if (_context.Clientes.Where(c => c.Name.Equals(cliente.Name)).FirstOrDefault() == null)
                {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'MiniCoreSahidCarchiContext.Cliente'  is null.");
            }
            var cliente = await _context.Clientes.FindAsync(id);
            if (cliente != null)
            {
